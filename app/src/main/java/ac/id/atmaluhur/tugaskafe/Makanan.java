package ac.id.atmaluhur.tugaskafe;
...
public class Makanan extends AppCompatActivity {
    ...
    private class AmbilDataMakanan extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ac.id.atmaluhur.tugaskafe.Makanan.this, "Loading Data.....", Toast.LENGTH_LONG).show();
        }
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            // koneksi ke php
            String url = "http://192.168.1.8/cafe/data_makanan.php";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(ac.id.atmaluhur.tugaskafe.Makanan.this, makananlist,
